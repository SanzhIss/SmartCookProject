...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    is_staff = models.BooleanField(default=False)  # Определяет может ли пользователь входить в админку
    is_active = models.BooleanField(default=True)
    wins = models.PositiveIntegerField(default=0)
    losses = models.PositiveIntegerField(default=0)
    score = models.PositiveIntegerField(default=0)
    awardBurger = models.BooleanField(default=False)
    awardBake = models.BooleanField(default=False)
    top_ten_achievement = models.BooleanField(default=False)
